...
function RouteComponent() {
  ...
  const generatePassword = () => {
    ...
    if (options.includeSymbols && charset.match(/[!@#$%^&*()_+\-=\[\]{}|;:,.<>?]/)) {
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 space-y-6">
      ...
      <div className="text-center">
        <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-2">Password Generator</h1>
        <p className="text-gray-600">Generate strong, secure passwords with customizable options</p>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
        ...
        <div className="mt-4">
          ...
          <div className="w-full bg-gray-200 rounded-full h-2">
            <div
              className={`h-2 rounded-full transition-all duration-300 ${strength.score <= 2 ? 'bg-red-500' :
      ...
      {/* Password Options */}
      <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
        <h2 className="text-lg font-semibold text-gray-900 mb-4">Password Options</h2>

        {/* Length Slider */}
        <div className="mb-6">
          <div className="flex items-center justify-between mb-2">
            <label className="text-sm font-medium text-gray-700">Password Length: {options.length}</label>
            <span className="text-sm text-gray-500 font-mono">{options.length} characters</span>
          </div>
          <input
            type="range"
            min="8"
          ...
          <div className="space-y-3">
            <label className="flex items-center">
              <input
                ...
                className="rounded border-gray-300 text-blue-600 focus:ring-blue-500"
              />
              <span className="ml-2 text-sm text-gray-700">Exclude Similar (i, l, 1, L, o, 0, O)</span>
            </label>
            <label className="flex items-center">
              <input
                type="checkbox"
                ...
                className="rounded border-gray-300 text-blue-600 focus:ring-blue-500"
              />
              <span className="ml-2 text-sm text-gray-700">Exclude Ambiguous (&#123; &#125; &#91; &#93; &#40; &#41; / \ &#39; &quot; ` ~ , ; : . &lt; &gt;)</span>
            </label>
          </div>
        </div>
      ...
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-xl p-6">
        <h3 className="text-lg font-semibold text-blue-800 mb-3">Password Security Tips</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-blue-700">
          <div>
            <h4 className="font-medium text-blue-800 mb-2">Strong Password Features:</h4>
      ...
      <div className="bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl p-6">
        ...
        <div className="text-sm text-gray-700 space-y-2">
          <p>• <strong>Length Control:</strong> Adjust password length from 8 to 64 characters</p>
          <p>• <strong>Character Types:</strong> Choose which character sets to include</p>
          <p>• <strong>Exclusion Options:</strong> Remove similar or ambiguous characters</p>
          <p>• <strong>Strength Analysis:</strong> Real-time password strength assessment</p>
          <p>• <strong>Passphrase Option:</strong> Generate memorable word-based passwords</p>
          <p>• <strong>Copy Function:</strong> Easy one-click copying to clipboard</p>
        </div>
      </div>
