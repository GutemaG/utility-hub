...
function RouteComponent() {
  ...
  const convertTemperature = (value: string, fromUnit: string) => {
    ...
    const fromUnitData = temperatureUnits.find(
      (unit) => unit.symbol === fromUnit
    );
      ...
      <div className="max-w-6xl mx-auto p-4 space-y-6">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600">
            Convert between different temperature scales instantly
          </p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6">
            ...
            <div className="flex-1 max-w-xs">
              ...
              >
                {temperatureUnits.find((u) => u.symbol === fromUnit)?.name} (
                {fromUnit})
              </label>
              <input
                id="mainFromInput"
            ...
            <div className="flex-1 max-w-xs">
              ...
              <label className="block text-sm font-medium text-gray-700 mb-2">
                {temperatureUnits.find((u) => u.symbol === toUnit)?.name} (
                {toUnit})
              </label>
              ...
              <div className="p-4">
                ...
                {values[unit.symbol] && !isNaN(Number(values[unit.symbol])) && (
                  <div className="mt-2 text-sm">
                    <span
                      className={`font-medium ${getTemperatureColor(Number(values[unit.symbol]), unit.symbol)}`}
                    >
                      {(() => {
            ...
            <div>
              ...
              <ul className="space-y-1">
                ...
                <li>
                  ...
                  Kelvin (K), Rankine (°R), Triple Point (°T)
                </li>
                <li>
                  •{" "}
