...
const timeUnits: TimeUnit[] = [
  ...
  },
  {
    name: "Centuries",
    symbol: "cent",
    toSeconds: 3153600000,
    category: "calendar",
  },
  {
    name: "Millennia",
    symbol: "mill",
    toSeconds: 31536000000,
    category: "calendar",
  },
  {
    name: "Milliseconds",
  ...
  },
  {
    name: "Picoseconds",
    symbol: "ps",
    toSeconds: 0.000000000001,
    category: "precision",
  },
  {
    name: "Femtoseconds",
    symbol: "fs",
    toSeconds: 0.000000000000001,
    category: "precision",
  },
  {
    name: "Attoseconds",
    symbol: "as",
    toSeconds: 0.000000000000000001,
    category: "precision",
  },
  {
    name: "Planck Time",
      ...
      <div className="max-w-6xl mx-auto p-4 space-y-6">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600">
            Convert between different time units instantly
          </p>
        </div>
                ...
                {values[unit.symbol] && !isNaN(Number(values[unit.symbol])) && (
                  <div className="mt-2 text-sm">
                    <span className="font-medium text-gray-700">
                      {(() => {
                        const time =
                          Number(values[unit.symbol]) * unit.toSeconds;
                  ...
                  <span
                    className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${
                      unit.category === "base"
                        ...
                        : unit.category === "calendar"
                          ? "bg-blue-100 text-blue-800"
                          : unit.category === "precision"
        ...
        <div className="bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-700">
            ...
            <div>
              ...
              <ul className="space-y-1">
                <li>
                  • <span className="font-medium text-green-700">Base:</span> s,
                  min, h, d, wk
                </li>
                <li>
