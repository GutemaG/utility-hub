...
const speedUnits: SpeedUnit[] = [
  ...
  },
  {
    ...
    symbol: "km/s",
    toMetersPerSecond: 1000,
    category: "metric",
  },
  {
    name: "Centimeters per Second",
    symbol: "cm/s",
    toMetersPerSecond: 0.01,
    category: "metric",
  },
  {
    name: "Mach Number",
  ...
  },
  {
    ...
    symbol: "yd/s",
    toMetersPerSecond: 0.9144,
    category: "imperial",
  },
  {
    name: "Inches per Second",
    symbol: "in/s",
    toMetersPerSecond: 0.0254,
    category: "imperial",
  },
  {
    name: "Miles per Second",
    symbol: "mi/s",
    toMetersPerSecond: 1609.344,
    category: "imperial",
  },
  {
  ...
  },
  {
    ...
    symbol: "fur/ftn",
    toMetersPerSecond: 0.0001663095,
    category: "historical",
  },
  {
    name: "Beard Seconds",
    symbol: "beard-s",
    toMetersPerSecond: 5.08e-9,
    category: "scientific",
  },
];
                ...
                {values[unit.symbol] && !isNaN(Number(values[unit.symbol])) && (
                  <div className="mt-2 text-sm">
                    <span className="font-medium text-gray-700">
                      {(() => {
                        const speed =
                          Number(values[unit.symbol]) * unit.toMetersPerSecond;
