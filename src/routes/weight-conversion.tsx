        ...
        <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6">
            ...
            <div className="flex-1 max-w-xs">
              ...
              >
                {weightUnits.find((u) => u.symbol === fromUnit)?.name} (
                {fromUnit})
              </label>
              <input
                id="mainFromInput"
                ...
                {values[unit.symbol] && !isNaN(Number(values[unit.symbol])) && (
                  <div className="mt-2 text-sm">
                    <span className="font-medium text-gray-700">
                      {(() => {
                        const weight =
                          Number(values[unit.symbol]) * unit.toGrams;
            ...
            <div>
              ...
              <ul className="space-y-1">
                ...
                <li>
                  ...
                  lb, oz, US ton, UK ton, st, gr
                </li>
                <li>
                  •{" "}
                  <span className="font-medium text-purple-700">Jewelry:</span>{" "}
                  ct (carats)
                </li>
                <li>
                  •{" "}
