...
const areaUnits: AreaUnit[] = [
  { name: 'Square Meters', symbol: 'm²', toSquareMeters: 1, category: 'metric' },
  { name: 'Square Kilometers', symbol: 'km²', toSquareMeters: 1000000, category: 'metric' },
  { name: 'Square Centimeters', symbol: 'cm²', toSquareMeters: 0.0001, category: 'metric' },
  { name: 'Square Millimeters', symbol: 'mm²', toSquareMeters: 0.000001, category: 'metric' },
  { name: 'Square Feet', symbol: 'ft²', toSquareMeters: 0.092903, category: 'imperial' },
  { name: 'Square Yards', symbol: 'yd²', toSquareMeters: 0.836127, category: 'imperial' },
  { name: 'Square Inches', symbol: 'in²', toSquareMeters: 0.00064516, category: 'imperial' },
  { name: 'Square Miles', symbol: 'mi²', toSquareMeters: 2589988.11, category: 'imperial' },
  { name: 'Acres', symbol: 'ac', toSquareMeters: 4046.86, category: 'imperial' },
  { name: 'Hectares', symbol: 'ha', toSquareMeters: 10000, category: 'metric' },
  { name: 'Square Nautical Miles', symbol: 'nmi²', toSquareMeters: 3429904, category: 'nautical' },
  { name: 'Square Astronomical Units', symbol: 'AU²', toSquareMeters: 2.237e22, category: 'astronomical' },
  { name: 'Square Light Years', symbol: 'ly²', toSquareMeters: 8.95e31, category: 'astronomical' },
  { name: 'Square Parsecs', symbol: 'pc²', toSquareMeters: 9.52e32, category: 'astronomical' },
  { name: 'Barns', symbol: 'b', toSquareMeters: 1e-28, category: 'scientific' },
  { name: 'Square Angstroms', symbol: 'Å²', toSquareMeters: 1e-20, category: 'scientific' }
]
  ...
  return (
    <div className="max-w-6xl mx-auto p-4 space-y-6">
      ...
      <div className="text-center">
        <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-2">Area Converter</h1>
        <p className="text-gray-600">Convert between different area units instantly</p>
      </div>

      {/* From/To Selector with Input and Result */}
      <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
        <h3 className="text-lg font-semibold text-gray-900 mb-4 text-center">Convert Area</h3>
              ...
              {values[unit.symbol] && !isNaN(Number(values[unit.symbol])) && (
                <div className="mt-2 text-sm">
                  <span className="font-medium text-gray-700">
                    {(() => {
                      const area = Number(values[unit.symbol]) * unit.toSquareMeters
      ...
      <div className="bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-700">
          ...
          <div>
            ...
            <ul className="space-y-1">
              <li>• <span className="font-medium text-green-700">Metric:</span> m², km², cm², mm², ha</li>
              <li>• <span className="font-medium text-blue-700">Imperial:</span> ft², yd², in², mi², ac</li>
              <li>• <span className="font-medium text-purple-700">Nautical:</span> nmi²</li>
              <li>• <span className="font-medium text-orange-700">Astronomical:</span> AU², ly², pc²</li>
              <li>• <span className="font-medium text-red-700">Scientific:</span> b, Å²</li>
            </ul>
          </div>
        </div>
      </div>
