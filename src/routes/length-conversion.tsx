...
const lengthUnits: LengthUnit[] = [
  ...
  { name: 'Nautical Miles', symbol: 'nmi', toMeters: 1852, category: 'nautical' },
  { name: 'Light Years', symbol: 'ly', toMeters: 9.461e15, category: 'astronomical' },
  { name: 'Astronomical Units', symbol: 'AU', toMeters: 1.496e11, category: 'astronomical' },
  { name: 'Parsecs', symbol: 'pc', toMeters: 3.086e16, category: 'astronomical' },
]
  ...
  return (
    <div className="max-w-6xl mx-auto p-4 space-y-6">
      ...
      <div className="text-center">
        <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-2">Length Converter</h1>
        <p className="text-gray-600">Convert between different length units instantly</p>
      </div>

      {/* From/To Selector with Input and Result */}
      <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
        <h3 className="text-lg font-semibold text-gray-900 mb-4 text-center">Convert Length</h3>
        <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-6">
          {/* From Section */}
          <div className="flex-1 max-w-xs">
            {/* Input Field */}
            <label htmlFor="mainFromInput" className="block text-sm font-medium text-gray-700 mb-2">
              {lengthUnits.find(u => u.symbol === fromUnit)?.name} ({fromUnit})
            </label>
            <input
              id="mainFromInput"
              type="text"
      ...
      <div className="bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-700">
          ...
          <div>
            ...
            <ul className="space-y-1">
              <li>• <span className="font-medium text-green-700">Metric:</span> m, km, cm, mm</li>
              <li>• <span className="font-medium text-blue-700">Imperial:</span> in, ft, yd, mi</li>
              <li>• <span className="font-medium text-purple-700">Nautical:</span> nmi</li>
              <li>• <span className="font-medium text-orange-700">Astronomical:</span> ly, AU, pc</li>
            </ul>
          </div>
        </div>
      </div>
