...
function RouteComponent() {
  ...
  const convertShoeSize = (value: string, fromUnit: string) => {
    ...
    const fromSystem = shoeSizeSystems.find(
      (system) => system.symbol === fromUnit
    );
    ...
    shoeSizeSystems.forEach((system) => {
      if (system.symbol === fromUnit) {
        ...
        const roundedSize =
          Math.round(convertedSize / system.step) * system.step;
      ...
      <div className="max-w-6xl mx-auto p-4 space-y-6">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600">
            Convert between international shoe sizing systems and foot length
          </p>
        </div>
              ...
              <div className="p-4">
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={(e) =>
                      handleInputChange(e.target.value, system.symbol)
                    }
                ...
                <div className="mt-2 text-xs text-gray-600">
                  Range: {system.minSize} - {system.maxSize} (
                  {system.step === 0.5 ? "0.5" : "1"} step)
                </div>
                ...
                <div className="mt-2">
                  <span
                    className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${
                      system.category === "north-america"
                        ? "bg-blue-100 text-blue-800"
                        : system.category === "europe"
                          ? "bg-green-100 text-green-800"
                          : system.category === "asia"
                            ? "bg-purple-100 text-purple-800"
                            : system.category === "oceania"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-700">
            ...
            <div>
              ...
              <ul className="space-y-1">
                ...
                <li>
                  • <span className="font-medium text-green-700">Europe:</span>{" "}
                  UK, EU
                </li>
                <li>
                  • <span className="font-medium text-purple-700">Asia:</span>{" "}
                  JP/CM
                </li>
                <li>
                  •{" "}
                  <span className="font-medium text-orange-700">Oceania:</span>{" "}
                  AU
                </li>
              </ul>
            </div>
