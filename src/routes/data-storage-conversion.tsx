...
const dataUnits: DataUnit[] = [
  ...
  { name: "Megabytes", symbol: "MB", toBytes: 1024 * 1024, category: "metric" },
  {
    name: "Gigabytes",
    symbol: "GB",
    toBytes: 1024 * 1024 * 1024,
    category: "metric",
  },
  {
    name: "Terabytes",
    symbol: "TB",
    toBytes: 1024 * 1024 * 1024 * 1024,
    category: "metric",
  },
  {
    name: "Petabytes",
    symbol: "PB",
    toBytes: 1024 * 1024 * 1024 * 1024 * 1024,
    category: "metric",
  },
  {
    name: "Exabytes",
    symbol: "EB",
    toBytes: 1024 * 1024 * 1024 * 1024 * 1024 * 1024,
    category: "metric",
  },
  {
    name: "Zettabytes",
    symbol: "ZB",
    toBytes: 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024,
    category: "metric",
  },
  {
    name: "Yottabytes",
    symbol: "YB",
    toBytes: 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024 * 1024,
    category: "metric",
  },
  ...
  { name: "Megabits", symbol: "Mb", toBytes: 128 * 1024, category: "metric" },
  {
    name: "Gigabits",
    symbol: "Gb",
    toBytes: 128 * 1024 * 1024,
    category: "metric",
  },
  {
    name: "Terabits",
    symbol: "Tb",
    toBytes: 128 * 1024 * 1024 * 1024,
    category: "metric",
  },
  {
    name: "Petabits",
    symbol: "Pb",
    toBytes: 128 * 1024 * 1024 * 1024 * 1024,
    category: "metric",
  },
      ...
      <div className="max-w-6xl mx-auto p-4 space-y-6">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600">
            Convert between different data storage units instantly
          </p>
        </div>
        ...
        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-4">
          ...
          <div className="flex flex-wrap gap-2">
            {[1024, 1048576, 1073741824, 1099511627776, 1125899906842624].map(
              (value) => (
                <button
                  key={value}
                    ...
                    className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${
                      unit.category === "base"
                        ...
                        : unit.category === "metric"
                          ...
                          : unit.category === "binary"
                            ? "bg-blue-100 text-blue-800"
                            : unit.category === "computer"
        ...
        <div className="bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-700">
            ...
            <div>
              ...
              <ul className="space-y-1">
                <li>
                  • <span className="font-medium text-gray-700">Base:</span> B,
                  b, nibble
                </li>
                <li>
                ...
                <li>
                  • <span className="font-medium text-blue-700">Binary:</span>{" "}
                  KiB, MiB, GiB, TiB, PiB, EiB, ZiB, YiB
                </li>
                <li>
                  •{" "}
                  <span className="font-medium text-purple-700">Computer:</span>{" "}
                  word, word64
                </li>
                <li>
                  • <span className="font-medium text-red-700">Bits:</span> Kb,
                  Mb, Gb, Tb, Pb
                </li>
              </ul>
            </div>
